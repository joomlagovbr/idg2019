...
echo '<div class="ph-cpanel-logo">'.JHtml::_('image', $this->t['i'] . 'logo-phoca-download.png', 'Phoca.cz') . '</div>';
echo '<div style="clear:both;"></div>';
echo '<h3>'.JText::_($this->t['l'].'_PHOCA_DOWNLOAD').' - '. JText::_($this->t['l'].'_INFORMATION').'</h3>';
