...
<table class="table">
  ...
  <tbody>
    <tr>
      <td><?php echo $this->item->jcFields['responsavel']->rawvalue ?></td>
    </tr>
  </tbody>
</table>
    </div>
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td><?php echo $this->item->jcFields['emailsetor']->rawvalue ?></td>
    </tr>
  </tbody>
</table>
    </div>
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td><?php echo $this->item->jcFields['telefonesetor']->rawvalue ?></td>
    </tr>
  </tbody>
</table>
    </div>
