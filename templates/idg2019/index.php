...
<html lang="pt-br">
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/css/custom.css?v=2">
						...
						<div class="header-wrapper">
							...
							<div id="logo" class="span8<?php if($this->params->get('classe_nome_principal', '') != '') echo ' '.$this->params->get('classe_nome_principal'); ?>">
		                        <a href="<?php echo JURI::root(); ?>" title="<?php echo $sitename; ?>">
		                            ...
		                            <img src="<?php echo JURI::root(); ?><?php echo $this->params->get('emblema', ''); ?>" alt="<?php echo $sitename; ?>" />
		                            <?php endif; ?>
		                            <span class="portal-title-1"><?php echo $this->params->get('subordinacao', ''); ?></span>
									<span class="portal-description"><?php echo $this->params->get('nome_principal', ''); ?></span>
									<h1 class="portal-title corto"><?php echo $this->params->get('denominacao', ''); ?></h1>
		                        </a>
		                    </div>
