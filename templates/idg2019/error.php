...
TmplPadraoGoverno2019Helper::clearDefaultScripts( $this );
$active_item = TmplPadraoGoverno2019Helper::getActiveItemid();
...
<body>
    ...
    <?php endif; ?>
    <!-- debug -->
    <?php TmplPadraoGoverno2019Helper::debug( @$preffix, @$active_item); ?>    
</body>
</html>